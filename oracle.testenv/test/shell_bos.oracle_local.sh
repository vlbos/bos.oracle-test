...
cleos push action $EOS_TOKEN transfer '["eosio.token", "appeallant1", "1000.0000 BOS", ""]' -p $EOS_TOKEN
cleos push action $EOS_TOKEN transfer '["eosio.token", "appeallant2", "1000.0000 BOS", ""]' -p $EOS_TOKEN
cleos push action $EOS_TOKEN transfer '["eosio.token", "appeallant3", "1000.0000 BOS", ""]' -p $EOS_TOKEN
...
###=============================================== appeal 申诉, ok
cleos push action $EOS_ORACLE appeal '["appeallant1", 0, "1.0000 BOS", "appeallant1", 1]' -p appeallant1@active
