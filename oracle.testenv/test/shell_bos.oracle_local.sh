...
ACCOUNTS=(
    "eosio.token" "bos.oracle" "appeallant1" "appeallant2" "appeallant3"  "arbitrator11" "arbitrator12" "arbitrator13" "arbitrator14" "arbitrator15"
    "provider1111"
)
...
cleos push action $EOS_TOKEN transfer '["eosio.token", "appeallant1", "1000.0000 EOS", ""]' -p $EOS_TOKEN
cleos push action $EOS_TOKEN transfer '["eosio.token", "appeallant2", "1000.0000 EOS", ""]' -p $EOS_TOKEN
cleos push action $EOS_TOKEN transfer '["eosio.token", "appeallant3", "1000.0000 EOS", ""]' -p $EOS_TOKEN
...
###=============================================== regservice, ok
cleos push action $EOS_ORACLE regservice '{"service_id":0,  "account":"provider1111", "amount":"10.0000 EOS",  "data_format":"", "data_type":0, "criteria":"",
...
cleos push action $EOS_ORACLE rerespcase '["appeallant1", 0, 0, 0, false]' -p appeallant1@active
