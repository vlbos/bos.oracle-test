...
filter-on = burn.bos:transfern2h:
filter-on = burn.bos:transfert2h:
filter-on = burn.bos:transfer2he:
filter-on = burn.bos:transfer2fe:
filter-on = burn.bos:collecte:
# filter-on = burn.bos:[transfer2he,transfer2fe,collectedsig]:*
