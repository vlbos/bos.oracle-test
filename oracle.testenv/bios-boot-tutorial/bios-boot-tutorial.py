...
if __name__ == '__main__':
    ...
    parser.add_argument('--cleos', metavar='', help="Cleos command", default=workDir+'/build/programs/cleos/cleos --wallet-url http://127.0.0.1:6666 ')
    parser.add_argument('--nodeos', metavar='', help="Path to nodeos binary", default=workDir+'/build/programs/nodeos/nodeos')
    parser.add_argument('--keosd', metavar='', help="Path to keosd binary", default=workDir+'/build/programs/keosd/keosd')
